...
const INDIAN_CITIES = [
  ...
  // Tier 2 cities
  'Agra', 'Allahabad', 'Prayagraj', 'Amritsar', 'Asansol', 'Aurangabad', 'Bareilly',
  'Belgaum', 'Belagavi', 'Bhilai', 'Bhiwandi', 'Bokaro', 'Chandigarh', 'Coimbatore',
  'Cuttack', 'Dehradun', 'Dhanbad', 'Durgapur', 'Erode', 'Faridabad', 'Ghaziabad',
  'Gorakhpur', 'Guntur', 'Guwahati', 'Gwalior', 'Hubli', 'Hubballi', 'Jabalpur',
  'Jalandhar', 'Jammu', 'Jamnagar', 'Jamshedpur', 'Jhansi', 'Jodhpur', 'Kakinada',
  'Kochi', 'Kolhapur', 'Kollam', 'Kota', 'Kozhikode', 'Kurnool', 'Latur', 'Madurai',
  'Malegaon', 'Mangalore', 'Mangaluru', 'Mathura', 'Meerut', 'Mysore', 'Mysuru',
  'Nashik', 'Navi Mumbai', 'Nellore', 'Noida', 'Patna', 'Pimpri-Chinchwad',
  'Pondicherry', 'Puducherry', 'Raipur', 'Rajahmundry', 'Ranchi', 'Rourkela',
  'Saharanpur', 'Salem', 'Sangli', 'Satara', 'Shimla', 'Siliguri', 'Solapur',
  ...
  'Bihar Sharif', 'Bilaspur', 'Bokaro Steel City', 'Bulandshahr', 'Chennai',
  'Chittoor', 'Davanagere', 'Dhule', 'Dimapur', 'Dibrugarh', 'Eluru',
  'Gandhinagar', 'Gangtok', 'Gaya', 'Gurgaon', 'Gurugram', 'Hapur', 'Haridwar',
  'Hisar', 'Hosur', 'Imphal', 'Itanagar', 'Jagtial', 'Jalgaon', 'Jalna',
  'Jeypore', 'Jorhat', 'Kadapa', 'Karnal', 'Karimnagar', 'Kavaratti',
  'Khammam', 'Khandwa', 'Khanna', 'Kishanganj', 'Kottayam', 'Kulti',
  'Kumbakonam', 'Leh', 'Loni', 'Mahbubnagar', 'Maheshtala', 'Muzaffarnagar',
  'Muzaffarpur', 'Nagercoil', 'Naihati', 'Nanded', 'Narnaul', 'Navsari',
  'Noida Extension', 'Ongole', 'Palakkad', 'Panaji', 'Panipat', 'Parbhani',
  'Pathankot', 'Patiala', 'Patna', 'Proddatur', 'Purnia', 'Raichur',
  'Rampur', 'Raniganj', 'Ropar', 'Rupnagar', 'Sagar', 'Sambalpur',
  'Sangli-Miraj', 'Sikar', 'Sri Ganganagar', 'Sultanpur', 'Tadepalligudem',
  'Tadipatri', 'Tenali', 'Thane', 'Thanjavur', 'Thoothukudi', 'Tiruppur',
  'Tumkur', 'Udaipur', 'Unnao', 'Vapi', 'Vasco da Gama', 'Vijayawada',
  'Viluppuram', 'Virar', 'Visakhapatnam', 'Vizianagaram', 'Warangal',
  'Yamunanagar', 'Zirakpur',
  // State capitals and major towns
  'Agartala', 'Aizawl', 'Chandigarh', 'Dehradun', 'Dispur', 'Gangtok',
  'Imphal', 'Itanagar', 'Jaipur', 'Kohima', 'Lucknow', 'Panaji',
  'Puducherry', 'Raipur', 'Ranchi', 'Shillong', 'Shimla', 'Srinagar',
  'Thiruvananthapuram',
];
