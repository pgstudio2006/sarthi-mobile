...
const QUESTIONS: LocalizedQuestion[] = [
  {
    ...
    Tamil: { text: `நடக்கும் சூழ்நிலைக்கு பொருந்தாத விதமாக குழந்தை உணர்ச்சிகளை வெளிப்படுத்துகிறதா?`, tip: `யாருக்காவது காயம் ஏற்பட்டால் குழந்தை சிரிக்கத் தொடங்கும், அல்லது எல்லோரும் மகிழ்ச்சியாக இருக்கும்போது குழந்தை திடீரென அழத் தொடங்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `சிறிய விஷயங்களுக்குக் கூட குழந்தை மிகவும் அதிகமாக அழுகிறதா, கோபப்படுகிறதா அல்லது உற்சாகப்படுகிறதா?`, tip: `வேறு ஒரு கப் அல்லது தட்டு கொடுத்ததற்காக குழந்தை நீண்ட நேரம் அழுது கொண்டே இருக்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `எந்தத் தெளிவான காரணமும் இல்லாமல் குழந்தை திடீரென சிரிக்கவோ, அழவோ அல்லது மிகவும் உற்சாகமாகவோ ஆகிறதா?`, tip: `சுற்றிலும் எதுவும் நடக்காதபோதும் குழந்தை திடீரென சிரிக்க, அழ அல்லது குதிக்கத் தொடங்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `ஆபத்தான இடங்கள் அல்லது பொருட்களைப் பார்த்தும் குழந்தை பயமின்றி அவற்றின் அருகே செல்ல முயற்சிக்கிறதா?`, tip: `குழந்தை சாலையை நோக்கி ஓடுவது, சூடான பொருளைத் தொட முயற்சிப்பது அல்லது உயரமான இடத்தில் ஏறுவது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `எந்தத் தெளிவான காரணமும் இல்லாமல் குழந்தை திடீரென மிகவும் உற்சாகமாகவோ அல்லது மிகவும் பதற்றமாகவோ ஆகிறதா?`, tip: `எந்த காரணமும் இல்லாமல் குழந்தை திடீரென சத்தமாக அழவோ அல்லது அதிகமாக ஓடி விளையாடவோ தொடங்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
];
    ...
    <SafeAreaView style={[styles.container, { paddingTop: top }]}>
      ...
      <View style={[styles.header, { paddingHorizontal: padding }]} onLayout={onLayoutHeader}>
        <View style={styles.headerTop}>
          <Text style={[styles.sectionLabel, { fontSize: scaleFont(12), color: '#2BA8A6' }]}>{t('sectionProgress', { section: '02', total: '06' })}</Text>
