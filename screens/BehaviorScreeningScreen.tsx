...
const QUESTIONS: LocalizedQuestion[] = [
  {
    ...
    Tamil: { text: `குழந்தை ஒரே மாதிரியான உடல் அசைவுகளை மீண்டும் மீண்டும் செய்கிறதா?`, tip: `மகிழ்ச்சியாக இருக்கும்போது அல்லது உற்சாகமாக இருக்கும்போது, குழந்தை கைகளை மீண்டும் மீண்டும் அசைப்பது, உடலை முன்-பின் ஆட்டுவது அல்லது சுற்றிச் சுற்றி வருவது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `குழந்தை ஏதாவது ஒரு பொருளின் மீது அதிகமாக பற்றுக் கொள்கிறதா?`, tip: `ஒரே பொம்மை, பாட்டில், ஸ்பூன் அல்லது துணியை எப்போதும் தன்னுடன் வைத்திருக்க விரும்பும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `ஒரே இடத்தில் அமைதியாக உட்கார குழந்தைக்கு சிரமமாக இருக்கிறதா?`, tip: `சாப்பிடும்போது, வகுப்பில் அல்லது கதை கேட்கும்போதும் குழந்தை அடிக்கடி எழுந்து நடக்கத் தொடங்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `கோபம் வந்தால் அல்லது நினைத்தது நடக்காவிட்டால், குழந்தை மற்றவர்களை அடிக்கிறதா, தள்ளுகிறதா அல்லது காயப்படுத்த முயற்சிக்கிறதா?`, tip: `பொம்மை கிடைக்காதபோது அல்லது தன் விருப்பம் நடக்காதபோது, குழந்தை மற்றொரு குழந்தையை அடிக்கவோ தள்ளவோ செய்யும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `சிறிய விஷயங்களுக்குக் கூட குழந்தை நீண்ட நேரம் அழுகிறதா, சத்தமாகக் கத்துகிறதா அல்லது அமைதியாக அதிக நேரம் எடுத்துக்கொள்கிறதா?`, tip: `பிடித்த பொருள் கிடைக்காவிட்டாலோ அல்லது வழக்கமான ரொட்டீன் மாறினாலோ, குழந்தை நீண்ட நேரம் அழுதுகொண்டே இருக்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `கோபம் அல்லது அதிக உற்சாகத்தில் குழந்தை தன்னைத்தானே காயப்படுத்திக்கொள்ளும் செயல்களைச் செய்கிறதா?`, tip: `குழந்தை தலையை சுவரில் முட்டிக்கொள்வது, தன்னைத்தானே அடிப்பது அல்லது கையை கடித்துக்கொள்வது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `தினசரி ரொட்டீன் அல்லது பழக்கத்தில் மாற்றம் வந்தால் குழந்தை மிகவும் வருத்தப்படுகிறதா?`, tip: `தினமும் செல்லும் வழி மாறினாலோ அல்லது பொருள் வேறு இடத்தில் இருந்தாலோ, குழந்தை மிகவும் வருத்தப்படலாம் அல்லது அழ ஆரம்பிக்கலாம்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
];
...
export default function BehaviorScreeningScreen({ navigation }: { navigation: any }) {
  ...
  const savedBehavior = screening.domainAnswers?.Behavior || [];
  const initialBehavior = Array(QUESTIONS.length)
    .fill(null)
    .map((_, i) => (typeof savedBehavior[i] === 'number' && !Number.isNaN(savedBehavior[i]) ? savedBehavior[i] : null));
  const [answers, setAnswers] = useState<(number | null)[]>(initialBehavior);
  ...
  useEffect(() => {
    const incoming = screening.domainAnswers?.Behavior || [];
    ...
    <SafeAreaView style={[styles.container, { paddingTop: top }]}>
      ...
      <View style={[styles.header, { paddingHorizontal: padding }]} onLayout={onLayoutHeader}>
        <View style={styles.headerTop}>
          <Text style={[styles.sectionLabel, { fontSize: scaleFont(12), color: '#D66A8E' }]}>{t('sectionProgress', { section: '04', total: '06' })}</Text>
          <Pressable onPress={() => { screening.saveProgress(); navigation.navigate('SaveExit', { sectionNumber: 4, answeredCount: answers.filter((a) => typeof a === 'number' && !Number.isNaN(a)).length, totalQuestions: QUESTIONS.length }); }} style={styles.saveExit} hitSlop={scaleSize(10)}>
