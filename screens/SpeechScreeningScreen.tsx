...
const QUESTIONS: LocalizedQuestion[] = [
  {
    ...
    Tamil: { text: `முன்பு பேசிய வார்த்தைகள் அல்லது சிறிய வாக்கியங்களை குழந்தை இப்போது பேசுவதை நிறுத்திவிட்டதா?`, tip: `முன்பு "அம்மா", "தண்ணீர்" என்று சொன்ன குழந்தை, இப்போது அந்த வார்த்தைகளைச் சொல்லுவதில்லை.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `தனக்குத் தேவையானதைச் சொல்ல குழந்தை கைசைகை, விரலால் காட்டுவது, கையை அசைப்பது அல்லது தலையசைப்பதை குறைவாகப் பயன்படுத்துகிறதா?`, tip: `தண்ணீர் வேண்டும் என்றால் விரலால் காட்டுவதற்குப் பதிலாக, குழந்தை கையைப் பிடித்து இழுக்கிறது அல்லது அழத் தொடங்குகிறது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `குழந்தை ஒரே வார்த்தையையோ அல்லது வாக்கியத்தையோ மீண்டும் மீண்டும் சொல்கிறதா?`, tip: `குழந்தை ஒரே வார்த்தையையோ அல்லது டிவியில் கேட்ட வாக்கியத்தையோ பலமுறை தொடர்ந்து சொல்லிக்கொண்டே இருக்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `மற்றவர்கள் சொல்வதை குழந்தை அதேபோல் திரும்பச் சொல்கிறதா?`, tip: `"தண்ணீர் வேண்டுமா?" என்று கேட்டால், பதில் சொல்லாமல் "தண்ணீர் வேண்டுமா?" என்று மீண்டும் சொல்கிறது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `பேசுவதற்குப் பதிலாக குழந்தை அடிக்கடி வித்தியாசமான சத்தங்களை எழுப்புகிறதா?`, tip: `குழந்தை அடிக்கடி கீச்சு சத்தம், முணுமுணுப்பு அல்லது ஒரே மாதிரியான சத்தங்களை எழுப்பிக்கொண்டே இருக்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `உரையாடலைத் தொடங்கவோ அல்லது தொடர்ந்து பேசவோ குழந்தைக்கு சிரமமாக இருக்கிறதா?`, tip: `குழந்தை சிறிய பதில் மட்டும் சொல்லிவிட்டு, அதற்கு மேல் பேசாமல் நிறுத்திவிடும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `மற்றவர்களுக்கு புரியாத வார்த்தைகளை குழந்தை பயன்படுத்துகிறதா?`, tip: `குழந்தை தானாக உருவாக்கிய வார்த்தைகள் அல்லது சத்தங்களை அடிக்கடி சொல்கிறது; ஆனால் அதன் அர்த்தம் மற்றவர்களுக்கு புரியாது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `தன்னைப் பற்றிப் பேசும்போது "நான்" என்பதற்குப் பதிலாக "நீ" அல்லது தனது பெயரையே குழந்தை பயன்படுத்துகிறதா?`, tip: `"எனக்கு தண்ணீர் வேண்டும்" என்பதற்குப் பதிலாக, "உனக்கு தண்ணீர் வேண்டும்" அல்லது தனது பெயரைச் சொல்லும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `மற்றவர்கள் என்ன சொல்ல விரும்புகிறார்கள் என்பதைப் புரிந்துகொள்ள குழந்தைக்கு சிரமமாக இருக்கிறதா?`, tip: `எளிமையாகச் சொன்ன பிறகும், குழந்தை அதன் அர்த்தத்தைப் புரிந்துகொள்ளாமல் அல்லது அதற்கு பொருத்தமான பதிலைச் சொல்லாமல் இருக்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
];
