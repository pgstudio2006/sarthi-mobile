...
const QUESTIONS: LocalizedQuestion[] = [
  {
    ...
    Tamil: { text: `பேசும்போது அல்லது விளையாடும்போது குழந்தை எதிரில் இருப்பவரின் முகத்தைப் பார்ப்பதைத் தவிர்க்கிறதா?`, tip: `குழந்தையின் பெயரை அழைத்தாலும், எதிரில் இருப்பவரைப் பார்க்காமல் பொம்மையையே பார்த்துக்கொண்டே இருக்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `யாராவது குழந்தையைப் பார்த்து புன்னகைத்தால், குழந்தை திரும்பப் புன்னகைக்காததுண்டா?`, tip: `பெற்றோர், ஆசிரியர் அல்லது தெரிந்தவர் புன்னகைத்தாலும், குழந்தை திரும்பப் புன்னகைக்காது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `குடும்பத்தினர் அல்லது மற்ற குழந்தைகளுடன் இருப்பதைவிட, குழந்தை தனியாக இருக்க விரும்புகிறதா?`, tip: `வீட்டில் அனைவரும் ஒன்றாக இருந்தாலும் அல்லது மற்ற குழந்தைகள் விளையாடிக் கொண்டிருந்தாலும், குழந்தை தனியாகவே இருக்க விரும்பும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `உதவி, ஆறுதல் அல்லது மகிழ்ச்சியைப் பகிர வேண்டிய நேரத்தில், குழந்தை தெரிந்தவர்களிடம் செல்லாமல் இருக்கிறதா?`, tip: `கீழே விழுந்த பிறகோ அல்லது புதிதாக ஏதாவது பார்த்த பிறகோ, குழந்தை பெற்றோர், ஆசிரியர் அல்லது கவனிப்பவரிடம் செல்லாது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `தன்னைச் சுற்றியுள்ளவர்களிடம் குழந்தை குறைவாகவே கவனம் செலுத்துகிறதா?`, tip: `தெரிந்தவர் பேசினாலும் அல்லது அறைக்குள் வந்தாலும், குழந்தை அவர்களைப் பெரிதாக கவனிக்காது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `மற்றவர்கள் என்ன செய்கிறார்கள் என்பதை குழந்தை கவனிக்காமல் அல்லது அதில் சேராமல் இருக்கிறதா?`, tip: `எல்லோரும் கைதட்டினாலும், எழுந்து நின்றாலும் அல்லது ஒரு செயல்பாட்டில் சேர்ந்தாலும், குழந்தை தனது வேலையையே தொடர்ந்து செய்யும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `குழந்தை தனியாக ஒரே மாதிரியான விளையாட்டை மீண்டும் மீண்டும் விளையாடுகிறதா?`, tip: `குழந்தை நீண்ட நேரம் ஒரே பொம்மையுடன் விளையாடுவது, பொருட்களை வரிசையாக அடுக்குவது அல்லது ஒரே செயலைத் தொடர்ந்து செய்வது வழக்கமாக இருக்கும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `மற்ற குழந்தைகளுடன் விளையாடும்போது, தனது முறைக்காக காத்திருக்க குழந்தைக்கு சிரமமாக இருக்கிறதா?`, tip: `மற்றவர்களுடன் விளையாடும்போது, தனது முறை முடிந்த பிறகும் குழந்தை பொம்மை அல்லது பந்தை மற்றவர்களிடம் கொடுக்காமல் வைத்துக்கொள்ளும்.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
  {
    ...
    Tamil: { text: `தனது வயதுள்ள மற்ற குழந்தைகளுடன் விளையாடவோ அல்லது பழகவோ குழந்தை தவிர்க்கிறதா?`, tip: `அருகில் மற்ற குழந்தைகள் விளையாடிக் கொண்டிருந்தாலும், குழந்தை அவர்களுடன் சேர முயற்சிக்காது.`, options: ['மிகக் குறைவாக', 'சில நேரங்களில்', 'அடிக்கடி', 'பெரும்பாலான நேரங்களில்', 'கிட்டத்தட்ட எப்போதும்'] },
  },
];
